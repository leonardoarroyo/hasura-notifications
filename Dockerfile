...
ENV HASURA_GRAPHQL_CORS_DOMAIN="https://*.conectadospelofuturo-ssg.com.br, https://conectadospelofuturo-ssg.com.br, https://admin.conectadospelofuturo-ssg.com.br/, http://localhost:3001/"
